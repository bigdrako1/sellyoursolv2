...
/**
 * Strategy interface defining the structure of a trading strategy
 */
interface Strategy {
  id: string;
  name: string;
...
/**
 * StrategyManager component for managing trading strategies
 * Allows users to view, configure, and toggle different trading strategies
 */
const StrategyManager = () => {
  ...
  /**
   * Get the appropriate icon for a strategy type
   */
