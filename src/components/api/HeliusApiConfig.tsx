 ...
 * Used in both AutoTrading and Settings pages
 */
const HeliusApiConfig: React.FC<HeliusApiConfigProps> = ({ 
  ...
  // Check connection status if showing connection status
  useEffect(() => {
    if (showConnectionStatus && hasApiKey) {
      checkApiConnection();
    }
  }, [showConnectionStatus, hasApiKey]);
