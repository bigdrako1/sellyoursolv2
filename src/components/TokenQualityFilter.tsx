    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Preview of tokens that would pass your current filter settings
          </CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <div className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                {quickFilterSelected === 'conservative' ? 
                  'Conservative settings will filter most tokens but may miss early opportunities.' :
                quickFilterSelected === 'aggressive' ? 
                  'Aggressive settings will catch more opportunities but carry higher risk.' :
                  'Current settings are balanced for risk vs. reward ratio.'}
              </AlertDescription>
            </Alert>
            
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <div className="text-sm font-medium">Tokens that pass filters</div>
                <div className="flex items-center justify-between">
              ...
              <div className="space-y-2">
                <div className="text-sm font-medium">Tokens that fail filters</div>
                <div className="flex items-center justify-between">
                  <span className="text-xs">Low liquidity</span>
            ...
            <div className="pt-2">
              <div className="text-sm font-medium mb-2">Sample tokens that pass filters</div>
              <div className="space-y-2">
                {['SOLAI', 'BONK', 'MINU'].map((symbol) => (
                  <div key={symbol} className="flex justify-between items-center p-2 rounded bg-gray-800/30">
